...
<div id="contiene-tabla" class="row">
  ...
  <input type="hidden" id="fechai" value="<?php echo date("Y/m/d"); ?>">
  ...
  <button id="btn_vsa" type="button" class="btn btn-sm" title="Voucher Saldos Agente"><i class="glyphicon glyphicon-check "></i></button>

  <!-- <button id="btn_metasxagente" onclick="fnMuestraMetasAgente__($('#nro_cuenta').val())" type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#dialogo_metasxagente__" title="Metas x Agente"><i class="fa fa-calendar"></i></button> -->
  <button id="btn_metasxagente" type="button" class="btn btn-default btn-sm" title="Metas x Agente"><i class="fa fa-calendar"></i></button>
  <button id="btn_precuadre" type="button" class="btn btn-default btn-sm" title="Pre Cuadre">PreCuadre</button>
    ...
    <table id="TMovsAgente" class="editinplace table-condensed table-bordered">
      <thead>
        <tr>
          ...
          <!--15-->
          <th align='right'> Saldo Agente</th>
