...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/css_totales.css">
    <link rel="stylesheet" type="text/css" href="css/simple-sidebar.css">
  ...
  <body>
    <div id="wrapper">
      ...
      <div class="page-content-wrapper">
        <?php include("TotalesForm.php"); ?>

        <?php include("TotalesTablas.php"); ?>

      </div>
    </div>
    
    <input type="hidden" id="sele_f" value="T[0]" >
    ...
    <script type="text/javascript" src="js/FuncionesTotales.js"></script>    
