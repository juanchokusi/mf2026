        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <div class="input-group input-group-sm">
                    ...
                    <input type="text" maxlength="3" class="form-control" id="inicial_banco" onkeyup='javascript:this.value = this.value.toUpperCase();'>
                </div>
                <div class="input-group input-group-sm">
		...
		<div class="input-group input-group-sm">
                ...
                <div class="input-group input-group-sm">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <select class="form-control" id="select_tipocuenta" > <option value="C">Cuenta</option> <option value="A">Agente</option> </select>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">                        
                        ...
                        <div id="contiene_tabla" class="table-responsive mygrid-wrapper-div">                                        
                            <table id="tabla_bancos" class="editinplace table-condensed ">
