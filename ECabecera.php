  ...
  <div class="container" >
    ...
    <div id="navbar" class="navbar-collapse collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#" class="glyphicon glyphicon-picture" id="carga_imagen"  title="Subir Voucher"></a></li>
        <!-- <li><a href="#" class="glyphicon glyphicon-remove" id="cambia_imagen"  title="Cambiar Voucher"></a></li> -->
