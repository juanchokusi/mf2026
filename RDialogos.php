<div id="dialogo_buscaclib">
    ...
    <select id="opciones_b" > <option value='A'>Apellido</option> <option value='D'>DNI</option> <option value='T'>Telefono</option> <option value='C'>Cuenta</option> </select>
    <input type="button" class="btn btn-default btn-xs  blue" Value="BUSCAR" onclick="EvaluaBusqueda();"/>
...
<div id="dialogo_buscasucu">
    <input type="text" style="text-transform:uppercase" id="codsucub" placeholder="Buscando Sucursal"/>    
...
<div id="dialogo_asigcuenta" title="Cuentas"> 
    <div class="input-group-sm">    
        ...
        <div id="div_nrocuenta_edit" class="input-group input-group-sm">                
            <input type="text" class="form-control" id="nrocuenta_edit" />
            <span class="input-group-btn">
                <a id="btn_update_cuenta" title="Guardar Edición de Cuentas" class="btn btn-default glyphicon glyphicon-floppy-disk"></a>
            </span>
        </div> 
        ...
        <button type="button" id="btn_eliminacuenta"  onclick="" title="Eliminar" class="btn btn-default btn-xs blue">
         ...
         <button type="button" id="btn_editacuenta"  onclick="" title="Editar" class="btn btn-default btn-xs blue">
            <span class="fa fa-pencil"></span>
        </button>
    </div>

    <!-- ========================================================================================================= -->
<!--     <div id="divcta__" class="table-responsive mygrid-wrapper-divcta" > 
    ...
    <div id="divcta" class="table-responsive mygrid-wrapper-divcta" > 
        <table id="tabla_cuentas" class="table table-condensed table-bordered">
            <thead>
                <tr>
                    <th>Nro. </th>
                    <th class='oculto' >id_cuenta </th>
                    <th>Nro. Cuenta</th>
                        <th>Iniciales</th>
                    <th>Banco</th>                            
                </tr>
            </thead>
            <tbody id="tbody_cuentascliente" >
...
<div id="dialogo_cliente">
    <div class="input-group-sm">
        ...
        <div class="input-group input-group-sm"> 
            ...
            <input type="text" class="form-control" id="fono_cliente" inputmode="numeric" pattern="[0-9]*" title = 'Solo se permiten números' >
        </div>
    </div>    
...
<input type="hidden" id="mitoken" value="<?php echo $_SESSION['mi_token']?>">
<input type="hidden" id="txt_cod_acreditado">
<input type="hidden" id="txt_idcuenta">