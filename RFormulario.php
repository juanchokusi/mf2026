<div class="row" id="formulario">
  ...
  <div class="col-xs-6 col-sm-3">
    ...
    <button id="btn_anular" type="button" class="normal btn btn-default btn-xs blue" title="Anular Giro">
    ...
    <button id="btn_yape" class="normal btn btn-default btn-xs" title="Pagar Yape" style=" display: inline-flex; align-items: center; gap: 2px; padding: 2px 4px; line-height: 2;">
      <img src="img/Icono_Yape2.png" style="display: block; width:22px; height:14px;">
    </button>
