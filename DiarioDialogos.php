...
<div id="dialogo_carga_recibos">
    <input type="hidden" id="correlativo_img" readonly="readonly">   
    <div class="input-group input-group-sm"> 
        <span class="input-group-addon">CODIGO</span>
        <input type="text" class="form-control" id="cod_recibos_img" readonly="readonly">
    </div>
    <div class="input-group input-group-sm"> 
        <span class="input-group-addon">Descripcion</span>
        <input type="text" class="form-control" id="descripcion_recibos_img" onkeyup='javascript:this.value = this.value.toUpperCase();'>        
    </div>
    <div id="fileuploader">Upload</div>
    <div class="form-group">        
        <button type="button" id="btn_guarda_recibos" class="btn btn-success">Guardar Recibos</button>
    </div>   

</div>


<div id="dialogo_recibo_img" title="Boucher">
    <div id="voucher_imge" class="printableArea">
        <img src="php/uploads/juancho411.jpg" id="imagen"/>
    </div>
    <button type="button" id="btn_imprime_recibo" class="btn btn-default btn-xs blue">Imprimir Recibo</button>
</div>
...
<input type="hidden" id="id_concepto_">
...
<input type="hidden" id="fecha_servidor">
<input type="hidden" id="extradata">
<input type="hidden" id="responsable">
<input type="hidden" id="iddetalle">
<input type="hidden" id="motivo_anulacion">