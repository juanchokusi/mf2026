...
<div id="dialogo_asigcuenta" title="Cuentas"  >
    ...
    <input type="text" id="nrodeoperacion" name="nrooperacion" style="text-transform:uppercase" class="form-control" placeholder="Nro de Operacion"  inputmode="numeric" pattern="[0-9]*" title = 'Solo se permiten números' />
    <div id="carga1" ></div>
...
<div id="dialogo_pagaagente" title="Paga con cuenta de Agente"  >
    ...
    <input type="text" id="datos_cuenta"     style="text-transform:uppercase" class="form-control" placeholder="Cuenta" readonly/>
...
<div id="dialogo_paga_con_sucu" title="Paga en Efectivo otra Sucursal"  >
    ...
    <input type="text" id="txt__sucursal" placeholder="Sucursal" readonly />
    <div id="carga1" ></div>
    <table id="tabla_agentes" class="table table-condensed ">
        <thead>
            <tr>
...
<div id="dialogo_voucher_imge" title="Boucher">
    ...
    <button type="button" id="btn_imprime_voucher" class="btn btn-success">Imprimir </button>
    <button type="button" id="btn_elimina_voucher" class="btn btn-danger">Eliminar </button>
</div>
...
<input type="hidden" id="mi_token"               value="<?php echo $_SESSION['mitoken'] ?>">
...
<input type="hidden" id="correlativo_img">
<input type="hidden" id="server_date">
<input type="hidden" id="codgirosucu_img">
